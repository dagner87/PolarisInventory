...
$config['tables']['login_attempts']  = 'intentos_acceso';
...
$config['default_group']              = 'Miembros';           // Default group, use name
$config['admin_group']                = 'Administradores';   // Default administrators group, use name
