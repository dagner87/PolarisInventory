                  ...
                  <div class="form-body">
                      <div class="row p-t-20">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" id="nombre_prove" name="nombre_prove" class="form-control" placeholder="Escriba el nombre">
                                  <small class="form-control-feedback"> </small> </div>
                          </div>
											<div class="col-md-6">
                              <div class="form-group">
                                  <label class="control-label">Telefono de contacto</label>
                                  <input type="number" id="telefono" name="telefono" class="form-control" placeholder="Escriba el telefono">
                                  <small class="form-control-feedback"> </small> </div>
                          </div>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="control-label">Direccion</label>
                                    ...
                                    <textarea class="textarea_editor form-control" id="direccion_prove" name="direccion_prove" 
                                              rows="10" placeholder="Direccion"></textarea>
                          ...
                          <!-- <div class="col-md-12">
                              <div class="form-group">
                                  <label class="control-label">Comentario</label>
                                    ...
                                    <textarea class="textarea_editor form-control" id="comentario" name="comentario" 
                                              rows="10" placeholder="Comentario "></textarea>
 ...
 <script src="<?= base_url() ?>plantilla/assets/plugins/html5-editor/bootstrap-wysihtml5.js"></script>
  ...
  <script>
    ...
    $('#add_form').submit(function(e) {
      e.preventDefault();			
      var url    = '<?php echo base_url() ?>insert_prov';
      var url_up = '<?php echo base_url() ?>update_prov';
    ...
    $(document).on("click",".edit-row-btn", function(){
        ...
        $.ajax({
                type: 'ajax',
                method: 'get',
                url: '<?php echo base_url() ?>get_prov',
                data: {id: id},
                async: false,
                dataType: 'json',
                success: function(data){
                   $('#nombre_prove').val(data.nombre_prove);
                   $('#telefono').val(data.telefono); 
                   $('#direccion_prove').data("wysihtml5").editor.setValue(data.direccion_prove);  
                   $('#comentario').data("wysihtml5").editor.setValue(data.comentario);                 
                },
                error: function(){
   ...
   $(document).on("click",".eliminar-row-btn", function(){
      ...
      swal({   
        ...
        if (isConfirm) {   
          ...
          $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo base_url() ?>delete_prov',
            data: {id: id},
            async: false,
            dataType: 'json',
            success: function(data){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>load_proveedores",
            method:"get",
            success:function(data)
            {						
