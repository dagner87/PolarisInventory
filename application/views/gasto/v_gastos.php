  ...
  <div class="card-body">
    ...
    <div class="table-responsive m-t-40">
      ...
      <div class="button-group">
        <button type="button" class="btn waves-effect waves-light btn-rounded  btn-info btn-success btn-add-new" data-toggle="modal" data-target="#show_modal">Nueva <?= $crud ?></button>
     </div>   
                      ...
                      <div class="row p-t-20">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="concepto" name="concepto" class="form-control" placeholder="Escriba el concepto">
                                  <small class="form-control-feedback"> </small> </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
 ...
 <script src="<?= base_url() ?>plantilla/assets/plugins/tinymce/tinymce.min.js"></script>
  ...
  <script>
    ...
    $('#add_form').submit(function(e) {
      e.preventDefault();
      var url    = '<?php echo base_url() ?>insert_gast';
      var url_up = '<?php echo base_url() ?>update_gast';
   ...
   /*----Editar  ----- */
    ...
    $(document).on("click",".edit-row-btn", function(){
        ...
        $.ajax({
                type: 'ajax',
                method: 'get',
                url: '<?php echo base_url() ?>get_gast',
                data: {id: id},
                async: false,
                dataType: 'json',
      ...
      swal({   
        ...
        if (isConfirm) {   
          ...
          $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo base_url() ?>delete_gast',
            data: {id: id},
            async: false,
            dataType: 'json',
            success: function(data){
   ...
   $(document).on("click",".btn-remove-producto", function(){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>load_gast",
            method:"post",
            success:function(data)
            {
