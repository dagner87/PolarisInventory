  ...
  <div class="card-body">
    ...
    <div class="table-responsive m-t-40">
      ...
      <div class="button-group">
        ...
        <button type="button" class="btn waves-effect waves-light btn-rounded btn-success btn-asi-ja" data-toggle="modal" data-target="#j_are_modal">Asignar Jefe <?= $crud ?></button>
     </div>   
                      ...
                      <div class="row p-t-20">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="control-label">Nombre de Area</label>
 ...
 <script src="<?= base_url() ?>plantilla/assets/plugins/html5-editor/bootstrap-wysihtml5.js"></script>
  ...
  <script>
    ...
    $('#add_form').submit(function(e) {
      e.preventDefault();
      var url    = '<?php echo base_url() ?>insert_are';
      var url_up = '<?php echo base_url() ?>update_are';
      ...
      swal({   
        ...
        if (isConfirm) {   
          ...
          $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo base_url() ?>delete_are',
            data: {id: id},
            async: false,
            dataType: 'json',
            success: function(data){
   ...
   $(document).on("click",".btn-remove-producto", function(){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>load_areas",
            method:"post",
            success:function(data)
            {
