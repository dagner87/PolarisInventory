 ...
 <script src="<?= base_url() ?>plantilla/assets/plugins/html5-editor/bootstrap-wysihtml5.js"></script>
  ...
  <script>
    ...
    $('#add_form').submit(function(e) {
      e.preventDefault();
      var url    = '<?php echo base_url() ?>insert_categ';
      var url_up = '<?php echo base_url() ?>update_categ';
    ...
    $(document).on("click",".edit-row-btn", function(){
        ...
        $.ajax({
                type: 'ajax',
                method: 'get',
                url: '<?php echo base_url() ?>get_categ',
                data: {id: id},
                async: false,
                dataType: 'json',
   ...
   $(document).on("click",".eliminar-row-btn", function(){
      ...
      swal({   
        ...
        if (isConfirm) {   
          ...
          $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo base_url() ?>delete_categ',
            data: {id: id},
            async: false,
            dataType: 'json',
            success: function(data){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>load_categorias",
            method:"get",
            success:function(data)
            {
