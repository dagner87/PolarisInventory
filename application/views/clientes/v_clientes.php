                  ...
                  <div class="form-body">
                      <div class="row p-t-20">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" id="nombre_cliente" name="nombre_cliente" class="form-control" placeholder="Escriba el nombre">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="control-label">Nota</label>
                                    ...
                                    <textarea class="textarea_editor form-control" id="nota" name="nota" 
                                              rows="10" placeholder="Especificacion"></textarea>
 ...
 <script src="<?= base_url() ?>plantilla/assets/plugins/html5-editor/bootstrap-wysihtml5.js"></script>
  ...
  <script>
    ...
    $('#add_form').submit(function(e) {
      e.preventDefault();			
      var url    = '<?php echo base_url() ?>insert_cliente';
      var url_up = '<?php echo base_url() ?>update_cliente';
    ...
    $(document).on("click",".edit-row-btn", function(){
        ...
        $.ajax({
                type: 'ajax',
                method: 'get',
                url: '<?php echo base_url() ?>get_cliente',
                data: {id: id},
                async: false,
                dataType: 'json',
                success: function(data){
                   ...
                   $('#nota').data("wysihtml5").editor.setValue(data.nota);  
                   $('#nota').data("wysihtml5").editor.setValue(data.nota);                 
                },
                error: function(){
   ...
   $(document).on("click",".eliminar-row-btn", function(){
      ...
      swal({   
        ...
        if (isConfirm) {   
          ...
          $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo base_url() ?>delete_cliente',
            data: {id: id},
            async: false,
            dataType: 'json',
            success: function(data){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>load_cliente",
            method:"get",
            success:function(data)
            {						
